...
#     model.load_state_dict(torch.load(f'./cifar10_SN_wideresnet_350_epochs_{sim}'))
    ...
    np.save(f'./auroc_tiny_imagenet_resnet_200_epochs_500_points_{sim}.npy',np.array([auc]))
    #np.save(f'./auroc_tiny_imagenet_resnet_SN_350_epochs_500_points_{sim}.npy',np.array([auc]))
    #np.save(f'./auroc_tiny_imagenet_wideresnet_SN_350_epochs_500_points_{sim}.npy',np.array([auc]))
